...
2. Add `STRIPE_SECRET_KEY` and `STRIPE_WEBHOOK_SECRET` as Cloudflare Pages encrypted secrets. Add these Stripe Price IDs as regular text variables: `STRIPE_PALWORLD_PRICE_ID_STARTER_6_MONTHLY`, `STRIPE_PALWORLD_PRICE_ID_FRONTIER_8_MONTHLY`, `STRIPE_PALWORLD_PRICE_ID_GUILD_12_MONTHLY`, `STRIPE_ZOMBOID_PRICE_ID_SAFEHOUSE_6_MONTHLY`, `STRIPE_ZOMBOID_PRICE_ID_SURVIVOR_8_MONTHLY`, and `STRIPE_ZOMBOID_PRICE_ID_OUTBREAK_12_MONTHLY`.
